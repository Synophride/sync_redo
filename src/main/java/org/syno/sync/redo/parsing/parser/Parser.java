...
/** PARSING **/
  ...
  final public BasicType type() throws ParseException {
    ...
    {if (true) return BasicType.BOOL;}
    } else if (jj_2_8(20)) {
      jj_consume_token(INT);
    {if (true) return BasicType.INT;}
    } else if (jj_2_9(20)) {
      jj_consume_token(REAL);
    {if (true) return BasicType.REAL;}
    } else {
      jj_consume_token(-1);
  ...
  Token t;
    if (jj_2_12(20)) {
      ...
      {if (true) return new SimplePattern(t.image);}
    } else if (jj_2_13(20)) {
      jj_consume_token(LPAR);
      p = pattern();
        subPatterns.add(p);
      ...
      jj_consume_token(RPAR);
    {if (true) return new CompoundPattern(subPatterns);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
  ...
  Token tokenBegin, tokenEnd;
    ...
    {if (true) return new Tuple(expressions);}
    throw new Error("Missing return statement in function");
  }
...
// TODO: Assoc droite ! 
  ...
  Token t;
    if (jj_2_45(20)) {
      ...
      {if (true) return new ConstReal(t.image);}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
